        ...
        /* 联系方式 */}
          <motion.section className="contact-section" variants={itemVariants}>
            ...
            <div className="contact-links">
              {[
                { icon: '📧', text: 'example@email.com', href: 'mailto:example@email.com' },
                { icon: '💼', text: 'github.com/yourusername', href: 'https://github.com/yourusername' },
                { icon: '🔗', text: 'linkedin.com/in/yourprofile', href: 'https://linkedin.com/in/yourprofile' },
                { icon: '🐦', text: 'twitter.com/yourhandle', href: 'https://twitter.com/yourhandle' }
              ].map((link, index) => (
                <motion.a
            key={link.text}
            href={link.href}
