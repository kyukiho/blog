    ...
    <div className="about-container">
      ...
      >
        ...
        <motion.div className="profile-card" variants={itemVariants}>
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}imgs/touxiang.jpg`} 
              alt="头像"
        ...
        <motion.section className="about-section" variants={itemVariants}>
          ...
          <div className="about-text">
            <p>
              我来自南京邮电大学软件工程专业，前端开发转行到agent开发，现在在上海小红书做b端ai出码工具，有传统业务研发经验，也了解ai产品/agent技术方案/ai coding相关信息。热爱技术开发，喜欢探索AI的最新发展，积极参与开源项目。
            </p>
            <p>
              大学期间在校大学生科学技术协会软件研发部前端组担任组长，在青柚工作室担任前端开发工程师，这也是对我技术学习影响非常大的两个社团，度过了很多实习后格外怀念的时光。
            </p>
            <p>
              个人生活方面喜欢散步骑车、阅读写作和烹饪手工，可能是研发中稀少的文艺b，INTJ但逐渐转E中。目前求职方向是互联网大厂的agent开发岗位，梦想是可以拿到高薪offer拼搏到三十五岁退休养狗。
            </p>
            <p>
          ...
          <motion.section className="contact-section" variants={itemVariants}>
            ...
            <div className="contact-links">
              {[
                ...
                { icon: '🔗', text: 'https://xhslink.com', href: 'https://xhslink.com/m/185n7E5ovju' },
              ].map((link, index) => (
                <motion.a
            key={link.text}
            href={link.href}
